  ...
  return (
    ...
    >
      <Grid container spacing={3}>
        <Grid item xs={12} sm={4} md={4} textAlign={'left'}>
          <Typography component='h2' variant='h4' color='text.primary' sx={{ fontVariant: 'all-small-caps', fontWeight: '100' }}>
            FAQ
          </Typography>
          <Typography variant='h1' color='text.primary' fontFamily={'Playfair Display'} mb={5}>
            Common Questions
          </Typography>
        ...
        <Grid item maxWidth={900} textAlign={'left'}>
          <Typography color='text.primary' mb={1} fontWeight='500' fontSize={24}>
            How can I search for accessible areas in NYC?
          </Typography>
          <Typography color='text.primary' mb={3} fontWeight='100' fontSize={20}>
